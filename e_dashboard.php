...
class chatbox_dashboard // include plugin-folder in the name.
{
	...
	function status()
	{
		...
		$var[0]['icon'] 	= "<img src='".e_PLUGIN_ABS."chatbox/images/chatbox_16.png' style='width: 16px; height: 16px; vertical-align: bottom' alt='' /> ";
		$var[0]['title'] 	= LAN_PLUGIN_CHATBOX_MENU_POSTS;
		$var[0]['url']		= e_PLUGIN."chatbox/admin_chatbox.php";
